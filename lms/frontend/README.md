...
This template should help get you started developing custom frontend for CIKKA
apps with Vue 3 and the CIKKA UI package.

This boilerplate sets up Vue 3, Vue Router, TailwindCSS, and CIKKA UI out of
the box.

## Usage

This template is meant to be cloned inside an existing CIKKA App. Assuming your
...
- [CIKKA UI](https://github.com/frappe/frappe-ui)
