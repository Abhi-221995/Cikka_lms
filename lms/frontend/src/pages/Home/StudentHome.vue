	...
	<div>
		<div class="mt-10 space-y-10">
			...
			<div v-if="myLiveClasses.data?.length">
				...
				<div class="grid grid-cols-1 md:grid-cols-4 gap-5">
					<div
						v-for="(cls, index) in myLiveClasses.data"
						:key="cls.name || index"
						class="border rounded-md hover:border-outline-gray-3 p-3 transition-colors animate-fade-in-up"
		...
		<div v-if="myCourses.data?.length" class="mt-10">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
				<router-link
					v-for="(course, index) in myCourses.data"
		...
		<div v-if="myBatches.data?.length" class="mt-10">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
				<router-link
					v-for="(batch, index) in myBatches.data"
