...
class TestLMSLiveClass(BaseTestUtils):
	...
	def setUp(self):
		...
		# Mock get_google_calendar_object to prevent CIKKA's Event hooks
	...
	def test_google_meet_live_class_creates_event(self):
		"""Creating a Google Meet live class should create a linked CIKKA Event."""
	...
	def test_delete_live_class_deletes_event(self):
		"""Deleting a live class should delete the linked CIKKA Event."""
		live_class = self._create_live_class()
		live_class.reload()
		event_name = live_class.event
