...
class BaseTestUtils(UnitTestCase):
	...
	def _create_course(self, title="Utility Course", instructor="frappe@example.com"):
		...
		course.update(
			{
				"title": title,
				"short_introduction": "A course to test utilities of CIKKA Learning",
				"description": "This is a detailed description of the Utility Course.",
				"tags": "CIKKA,Learning,Utility",
				"category": "Business",
				"published": 1,
	...
	def _setup_course_flow(self):
		...
		self.admin = self._create_user(
			"frappe@example.com", "CIKKA", "Admin", ["Moderator", "Course Creator", "Batch Evaluator"]
		)
